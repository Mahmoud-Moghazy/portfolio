      ...
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full p-2 px-4 ring-1 ring-white/10"
            style={{
              backdropFilter: "blur(16px) saturate(180%)",
              backgroundColor: "rgba(17, 25, 40, 0.75)",
            }}
          >
            <span className="relative z-20 text-emerald-400 text-xs font-bold py-0.5 whitespace-nowrap overflow-hidden text-ellipsis">
              {title}
            </span>
